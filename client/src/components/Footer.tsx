    ...
    <footer className="bg-black border-t border-white/10 py-16">
      <div className="container">
        <div className="flex flex-col md:flex-row justify-between items-center gap-8">
          <div className="text-center md:text-left">
            <h2 className="font-display text-4xl text-white uppercase tracking-wider">
              Selton <span className="text-jordan-red">Miguel</span>
            </h2>
          ...
          <div className="flex items-center gap-8">
            <a href="https://www.instagram.com/hollywood.sel/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-jordan-red transition-colors duration-300">
              <Instagram size={24} />
            </a>
            <a href="#" className="text-gray-400 hover:text-jordan-red transition-colors duration-300">
              <Facebook size={24} />
            </a>
            <a href="https://twitter.com/selton_miguel" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-jordan-red transition-colors duration-300">
              <Twitter size={24} />
            </a>
          </div>
        </div>
        ...
        <div className="mt-16 pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-gray-600 uppercase tracking-wider">
          <p>&copy; 2025 Selton Miguel. {t.footer.copyright}</p>
